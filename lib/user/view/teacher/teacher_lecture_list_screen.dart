...
class TeacherLectureListScreen extends ConsumerStatefulWidget {
  ...
  const TeacherLectureListScreen({super.key});

  @override
  ConsumerState<TeacherLectureListScreen> createState() =>
      _TeacherLectureListScreenState();
}

class _TeacherLectureListScreenState
    extends ConsumerState<TeacherLectureListScreen> {
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          TextButton(
                                            onPressed: () {
                                              context.goNamed(TeacherLectureApplyScreen.routeName, extra: lecture);
                                            },
                                            child: const Text(
                                              '신청현황',
                                              style: TextStyle(
  ...
  void _getMyLectureList() async {
    final response = await _lectureProvider.getLectureListByKeyword(_user.userId, 'teacherId');
